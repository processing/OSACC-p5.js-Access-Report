...
This event was a three-day conversation and ‘unconference’, populated by founders, maintainers, and contributors of Open Source Software Toolkits for the Arts (OSSTA) such as [p5.js](https://p5js.org/),  [Processing](https://processing.org/),  [ml5.js](https://ml5js.org/),  [openFrameworks](https://openframeworks.cc/),  [Hydra](https://hydra.ojack.xyz/),  [Netnet](http://netnet.studio/),  [New Art City](https://newart.city/),   [OPENRNDR](https://openrndr.org/), [Shaderpark](https://shaderpark.com/),  [Sonic Pi](https://sonic-pi.net/), and more.
