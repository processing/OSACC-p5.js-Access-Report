...
In the discussion, some good practices participants shared for accessible open source software were publishing a strategic plan for others to read and borrow for their own projects, sharing work transparently, and including documentation in code. Another important practice discussed is making tutorials and documentation. Some participants shared Marlin and Arduino as being good examples of this. 
 ...
 ![Image description: screenshot from the Marlin website on how to configure Arduino.](../0-images/access-marlin.png)
...
![Image description: screenshot of a p5.js Instagram post that contains alt text description in the caption.](../0-images/access-p5js-ig-caption.png)
Caption in the p5.js Instagram with alt text for the video

![Image description: screenshot of the New Art City Info Center and a list of current accessibility features on New Art City.](../0-images/access-new-art-city.png)
...
![Image description: screenshot of merged code containing alt text into the p5.js repository.](../0-images/access-gsoc.png)
...
![Image description: screenshot of Bobby Joe Smith III’s portfolio, specifically his “Decolonial Gesture” project.](../0-images/access-bobby-joe-smith.png)
...
![Image description: screenshot of the Deaf Queer Kor website. Person signs the word “gender identity”.](../0-images/access-ksl.png)
...
![Image description: screenshot of the homepage of the Hedy code website.](../0-images/access-hedy.png)
